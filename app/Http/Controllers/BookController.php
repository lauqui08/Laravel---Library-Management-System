...
class BookController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect(route('books.show',$request->book_id))->with('message','Successfully added new book.');
    }
    ...
    public function edit($id)
    {
        ...
        // dd(route('books.show',$id));
            ...
            ->get();
            // dd($authors);
            return view('books.edit',['book'=>$book,'authors'=>$authors,'all_authors'=>$all_authors]);
